...
| `5. Buyer Profile!B75` | HP electrical demand (kW) | `=IF(OR(NOT(ISNUMBER('1. Module Criteria'!B17)),'1. Module Criteria'!B17<=1),0,B41/'1. Module Criteria'!B17)` | `bp.hp_electrical_demand_kw = ifelse(or(not(isnumber(mc.heat_pump_cop)),mc.heat_pump_cop<=1),0,bp.system_thermal_capacity_kwth/mc.heat_pump_cop);` | ISNUMBER guard |
