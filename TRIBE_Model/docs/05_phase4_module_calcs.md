...
| `2. Module Capex!B29` | Fluid management system | `=IF(OR(B6="Single-Phase Immersion",B6="Two-Phase Immersion"),'11. Reference Data'!B89,0)` | `mcapex.fluid_management_system = ifelse(or_(mcapex.cooling_method=="Single-Phase Immersion",mcapex.cooling_method=="Two-Phase Immersion"),ref.fluid_management_system,0);` |  |
